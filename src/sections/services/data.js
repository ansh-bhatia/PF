...
const data = [
    ...
    {
        id: 4, icon: <AiFillAppstore/>, title: 'API Development', desc: 'Skilled in seamlessly connecting and integrating diverse systems to create robust and efficient web solutions.'
    }
]
